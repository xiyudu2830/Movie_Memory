...
CREATE TABLE "FactGenerationLock" (
    ...
    CONSTRAINT "FactGenerationLock_pkey" PRIMARY KEY ("userId")
);
...
-- CreateIndex
CREATE INDEX "MovieFact_userId_movieTitle_createdAt_idx" ON "MovieFact"("userId", "movieTitle", "createdAt" DESC);
